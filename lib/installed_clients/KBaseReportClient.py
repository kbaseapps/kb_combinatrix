...
try:
    ...
    from installed_clients.baseclient import BaseClient as _BaseClient  # @UnusedImport
except ImportError:
    # no they aren't
...
class KBaseReport(object):
    ...
    def render_template(self, params, context=None):
        ...
        """
        return self._client.run_job(
            "KBaseReport.render_template", [params], self._service_ver, context
        )
    ...
    def render_templates(self, params, context=None):
        ...
        """
        return self._client.run_job(
            "KBaseReport.render_templates", [params], self._service_ver, context
        )
